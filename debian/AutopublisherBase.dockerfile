...
RUN apt-install firefox-esr firefox-esr-l10n-ru libpython3.11-stdlib libreoffice-writer \
                python3-pip python3-xvfbwrapper python3.11-distutils python3.11-minimal \
